...
1. Attempt to write a prompt that instructs GitHub Copilot to write the entire feature at once. Let it run to completion.

    > As AI coding assistances get better, they can often figure out how to build entire features on their own for simple projects like this. The tools will only get better! 
